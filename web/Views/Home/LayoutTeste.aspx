            ...
            <ext:BorderLayout ID="BorderLayout1" runat="server">
                ...
                <West Collapsible="true" MinWidth="175" Split="true">
                       <ext:TreePanel 
                            ...
                            <Loader>
                                <ext:TreeLoader DataUrl="/Home/CarregaMenu" RequestMethod="POST" >
                                    <BaseParams>
                                        <ext:Parameter Name="idPerfil" Value="2" Mode="Value" />
                                    </BaseParams>
                                </ext:TreeLoader>
                            </Loader>                                        
                            <Root>
                                <ext:AsyncTreeNode NodeID="0" Text="SysCad" Icon="Application" AutoDataBind="true" />  
                            </Root>
